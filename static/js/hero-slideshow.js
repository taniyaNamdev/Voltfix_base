...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Product Search Bar Clear Button & Category Active State ---
    ...
    var catBtns = document.querySelectorAll('.category-btn-ref');
    ...
    var bookBtns = document.querySelectorAll('.book-now-btn');
    var bookingModal = document.getElementById('serviceBookingModal');
    var bookingServiceId = document.getElementById('bookingServiceId');
    var bookingServiceName = document.getElementById('bookingServiceName');
    if (bookBtns && bookingModal && bookingServiceId && bookingServiceName) {
        bookBtns.forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                bookingServiceName.value = serviceName;
